...
<div className='websec-1'>
        ...
        <div className='webp1'>
            ...
            <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWbXT4DvbZ0AH2sNKKGlTKspIKJsWS3sUT9A&usqp=CAU'/>
            <h5>Desktop Assistant</h5>
            <a href='https://github.com/Vishwajith-Shettigar/Assistant'><p>Open on Github </p></a>
        </div>
