...
function Header() {
 ...
 <nav className='navbar'>
  ...
  <li className='sec-1-op'><a href="#intro">Vishwajith Shettigar</a></li>
  {/* <li className='sec-1-op'><a href="#skills">Skills</a></li>
  <li className='sec-1-op'><a href="#Projects">Projects</a></li>
  <li className='sec-1-op'><a href="#contact">Contact</a></li> */}
